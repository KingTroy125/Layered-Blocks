    ...
    return (
        <section className="flex min-h-screen bg-white dark:bg-black px-4 py-16 md:py-32">
            <div className="relative flex flex-col rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black overflow-hidden transition-all duration-300 group hover:border-gray-400 dark:hover:border-gray-600 hover:shadow-lg m-auto h-fit w-full max-w-sm p-0.5">
                {/* Hover glow effect */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-black/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                <div className="relative z-10 p-8 pb-6">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="mb-2 text-2xl md:text-3xl font-normal leading-tight text-black dark:text-white">Sign In</h1>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <input
                                ...
                                name="pwd"
                                id="pwd"
                                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black hover:border-gray-400 dark:hover:border-gray-600 focus:border-black dark:focus:border-white focus:outline-none focus:ring-1 focus:ring-black/30 dark:focus:ring-white/30 transition-all text-sm"
                            />
                        </div>

                        {/* Sign in button */}
                        <button type="submit" className="w-full py-2.5 px-4 rounded-lg bg-black dark:bg-white hover:bg-gray-900 dark:hover:bg-gray-100 text-white dark:text-black font-medium transition-all text-sm mt-2">
                            Sign In
                        </button>
                    </div>
                </div>
                ...
                {/* Footer */}
                <div className="relative z-10 rounded-lg p-4 mx-0.5 mb-0.5">
